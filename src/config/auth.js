...
module.exports = (app) => {
      ...
      (cpf, senha, done) => {
        ...
        userDao
          ...
          .then((cpf) => {
            ...
            if (
              Object.keys(cpf).length > 0 &&
              !bcrypt.compareSync(senha, cpf[0].senha)
            ) {
              return done(null, false, {
                mensagem: 'Usuário ou senha incorretos!',
              });
  ...
  app.use(
    sessao({
      secret: [
        'X5f6oH8gaAwxrvM0OgI1FCbotQtshMiM',
        'Kd22KDvHFkAaFU86ufl0iLyipj8wiyM2',
        'POpdELY5mhuHcsaYcoioB9l2wK4ctyAb',
        'DELugjXEO4Un5IsrJJKVq7G2bLftpB5S',
      ],
