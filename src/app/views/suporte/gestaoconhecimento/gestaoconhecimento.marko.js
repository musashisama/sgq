...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/sgq$1.0.0/src/app/views/suporte/gestaoconhecimento/gestaoconhecimento.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"container\"><h3 class=\"center-align titulo\">Gestão do Conhecimento - COSUP</h3><div class=\"row\"><div class=\"input-field col s12\"><i class=\"material-icons prefix\">textsms</i><input type=\"text\" id=\"autocomplete-input\" class=\"autocomplete\"><label for=\"autocomplete-input\">Do que você precisa?</label></div></div><div id=\"gc\"" +
...
marko_template.meta = {
    id: "/sgq$1.0.0/src/app/views/suporte/gestaoconhecimento/gestaoconhecimento.marko",
    tags: [
