...
function render(input, out, __component, component, state) {
  ...
  out.w("</select><label for=\"mProcOrigem\">Em qual macroprocesso a NC teve origem?</label></div><div class=\"form-group input-field col s3\"><label for=\"titulo\">Unidade onde ocorreu a Não Conformidade</label><input required type=\"text\" id=\"titulo\" name=\"equipeNC\"" +
    ...
    "</textarea><label for=\"icon_prefix2\">Comentários do participante (opcional):</label></div></div><div class=\"row\"><div class=\"input-field col s3\"><p><label>Ação Imediata</label></p><p><label><input name=\"acaoImediata\" type=\"radio\" value=\"Correção\" checked><span>Correção</span></label></p> <p><label><input name=\"acaoImediata\" type=\"radio\" value=\"Encaminhada para Correção\"><span>NC encaminhada para correção</span></label></p></div><div class=\"input-field col s4\"><input type=\"text\" id=\"dataNC\" name=\"dataNC\" class=\"datepicker\"><label for=\"dataNC\">Quando ocorreu a NC?</label></div> </div><div class=\"row\"><div class=\"col s6 offset-s11\"><button class=\"btn-floating btn-large waves-effect waves-light green hoverable \" type=\"submit\"><i class=\"material-icons right-align\">add</i></button></div> </div></form><form action=\"/upload\" method=\"POST\" enctype=\"multipart/form-data\"><div class=\"row\"><div class=\"file-field input-field col s3\"><div class=\"btn\"><span>Arquivo</span><input type=\"file\" name=\"file\" id=\"file\"></div><div class=\"file-path-wrapper\"><input class=\"file-path validate\" type=\"text\" placeholder=\"Deseja enviar algum arquivo?\"></div></div> <div class=\"col s1\"><button class=\"btn-floating btn-large waves-effect waves-light green hoverable \" type=\"submit\"><i class=\"material-icons right-align\">attach_file</i></button></div> </div></form></div></main><footer class=\"rodape\"></footer> <div id=\"modal1\" class=\"modal\"><div class=\"modal-content\"><h4 class=\"hModal\">Modal Header</h4><p class=\"pModal\">A bunch of text</p></div><div class=\"modal-footer\"><a href=\"#!\" class=\"modal-close waves-effect waves-red btn-flat\">Cancela</a><a href=\"#!\" class=\"modal-close waves-effect waves-green btn-flat concorda\">Confirma</a></div></div> <script src=\"/estatico/js/jquery-3.4.1.js\"></script><script src=\"/estatico/js/materialize.js\"></script><script src=\"/estatico/js/services/HttpService.js\"></script><script src=\"/estatico/js/formcontrol.js\"></script> ");
