...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"row\"><div class=\"form-group input-field  col s3\"><label for=\"titulo\">Documento de referência:</label><input type=\"text\" id=\"titulo\" name=\"docRef\"" +
    ...
    " placeholder=\"Opcional (ex.: n° do Processo)\" class=\"form-control\"></div><div class=\"form-group input-field  col s3\"><label for=\"titulo\">Documento de referência:</label><input type=\"text\" id=\"titulo\" name=\"docRef\"" +
    marko_attr("value", data.registroNC.ssdocRef) +
  ...
  out.w("</div><script src=\"/estatico/js/jquery-3.4.1.js\"></script><script src=\"/estatico/js/materialize.js\"></script><script src=\"/estatico/js/services/HttpService.js\"></script><script src=\"/estatico/js/formcontrol.js\"></script>");
