...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.nc, function(nc) {
    ...
    out.w("<tr" +
      ...
      "</td><td class=\"td-edit\"><a class=\"modal-trigger\" href=\"#modal1\"><i class=\"small material-icons icones center-align\">edit</i></a></td><td class=\"td-remove\"><a class=\"modal-trigger\" href=\"#modal1\"><i class=\"aRemove small material-icons icones iconeRemove\"" +
