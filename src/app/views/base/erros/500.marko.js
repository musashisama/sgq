...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/sgq$1.0.0/src/app/views/base/erros/500.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<header class=\"container-header cabecalho\"></header><main class=\"conteudoPrincipal\"><ul id=\"slide-out\" class=\"sidenav\"></ul><div class=\"container\"><div class=\"row center\"><h1>ERRO INTERNO</h1><p>Algo deu errado. Tente novamente mais tarde.</p><a href=\"/\">Voltar</a></div></div></main><div id=\"modal1\" class=\"modal\"><div class=\"modal-content\"><h4 class=\"hModal\">Modal Header</h4><p class=\"pModal\"></p></div><div class=\"modal-footer\"></div></div><footer class=\"page-footer rodape\"></footer><script src=\"/estatico/js/libs/jquery-3.4.1.js\"></script><script src=\"/estatico/js/libs/materialize.js\"></script><script src=\"/estatico/js/loadtemplate.js\"></script><script src=\"/estatico/js/base/navbar.js\"></script><script src=\"/estatico/js/base/login.js\"></script>");
...
marko_template.meta = {
    id: "/sgq$1.0.0/src/app/views/base/erros/500.marko",
    tags: [
