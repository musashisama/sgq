...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/sgq$1.0.0/src/app/views/julgamento/gestaosolicitacoes/gestaoregsolicitacoes.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"container\"><h3 class=\"center-align titulo\">Gestão de Solicitações dos Conselheiros</h3><div id=\"solicitacoes\"" +
  ...
  app_footer_tag({}, out, __component, "51");

  app_modal_tag({}, out, __component, "52");

  app_scripts_js_tag({}, out, __component, "53");

  out.w("<script src=\"/estatico/js/libs/plotly-latest.min.js\"></script><script src=\"/estatico/js/libs/plotly-locale-pt-br.js\"></script><script>Plotly.setPlotConfig({locale: 'pt-BR'})</script><script src=\"/estatico/js/libs/quill.min.js\"></script><script src=\"/estatico/js/julgamento/gestaoregsolicitacoes.js\"></script>");
...
marko_template.meta = {
    id: "/sgq$1.0.0/src/app/views/julgamento/gestaosolicitacoes/gestaoregsolicitacoes.marko",
    tags: [
