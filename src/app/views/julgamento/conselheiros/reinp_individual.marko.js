...
function render(input, out, __component, component, state) {
  ...
  app_modal_tabela_legenda_tag({}, out, __component, "47");
  ...
  app_footer_tag({}, out, __component, "56");

  app_scripts_js_tag({}, out, __component, "57");
