...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"container\"><h3 class=\"center-align titulo nomeSol\"><strong>Cons. " +
    ...
    "></div><div class=\"row\"><div class=\"col s12\"><p><h6><strong>CPF:</strong><span id=\"cpfCons\">" +
    ...
    "</h6></p><p><h6>Falta(m) <strong><span id=\"daps\"></span></strong> dia(s) para a próxima sessão, que será realizada em <strong><span id=\"ps\"></span></strong>.</h6></p></div></div><h4>Inclusão de Solicitação</h4><div class=\"row\"></div></div></main><footer class=\"page-footer rodape\"></footer>");

  app_modal_tabela_legenda_tag({}, out, __component, "31");
