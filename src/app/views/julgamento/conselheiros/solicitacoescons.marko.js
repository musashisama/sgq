...
function render(input, out, __component, component, state) {
  ...
  app_footer_tag({}, out, __component, "64");

  app_scripts_js_tag({}, out, __component, "65");
