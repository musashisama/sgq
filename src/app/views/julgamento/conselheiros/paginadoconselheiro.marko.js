...
function render(input, out, __component, component, state) {
  ...
  out.w("</select><label>Selecione a data do relatório:</label></div><div class=\"progressReinp col s3\"><div class=\"preloader-wrapper small active\"><div class=\"spinner-layer spinner-green-only\"><div class=\"circle-clipper left\"><div class=\"circle\"></div></div><div class=\"gap-patch\"><div class=\"circle\"></div></div><div class=\"circle-clipper right\"><div class=\"circle\"></div></div></div></div></div></div><div id=\"idProdutividade\" class=\"row classProdutividade\"><div class=\"col s3 right-align\"></div><div class=\"col s12 right-align\"><div class=\"row\"></div><div id=\"tabelaReinp\"></div><div class=\"row\"><h4 class=\"left\">Processos</h4><a class=\"dropdownDownloadCons waves-effect waves-yellow hoverable z-depth-3 btn-floating red\" href=\"#\" data-target=\"dropdownReinp\"><i class=\"material-icons\">file_download</i></a><ul id=\"dropdownReinp\" class=\"dropdown-content\"><li class=\"divider\" tabindex=\"-1\"></li><li><a class=\"xlsxDownReinp\" href=\"#!\"><i class=\"xlsxDownReinp material-icons\">file_download</i>XLSX</a></li><li class=\"divider\" tabindex=\"-1\"></li><li><a class=\"csvDownReinp\" href=\"#!\"><i class=\"csvDownReinp material-icons\">file_download</i>CSV</a></li><li class=\"divider\" tabindex=\"-1\"></li></ul><a href=\"#!\" id=\"agrupaMes\" title=\"Agrupar/Desagrupar por Mês\" class=\"waves-effect waves-yellow hoverable z-depth-3 btn-floating blue\"><i class=\"material-icons\">unfold_less</i></a></div></div></div><div id=\"tabelaReinpDet\"></div></div><div id=\"stats\" class=\"col s12\"><div class=\"row classProcessos\"><h4>Quantidade de processos por atividade:</h4><p><div style=\"width:780px;auto;\" id=\"barrasAtividade\"></div></p></div><div class=\"row classProdutividade\"><h4>Produtividade Mensal e Trimestral:</h4></div><div class=\"row classProdutividade\"><div class=\"col s6\"><div id=\"barrasReinpMensal\"></div></div><div class=\"col s6\"><div id=\"barrasReinpTrimestral\"></div></div></div></div><div id=\"ocorrencias\" class=\"col s12\"><br><div class=\"row\"><div id=\"tabelaOcorrencias\"" +
  ...
  out.w("</select><label for=\"tipoSolicitacao\">Selecione o tipo de solicitação:</label></div></div><div class=\"row\"><div class=\"col s12\"><span id=\"divTipo\"></span></div></div><div class=\"row valign-wrapper\"><div id=\"enviaArq\" class=\"col s6 valign-wrapper\"></div><div id=\"mostraArq\" class=\"col s6\"><ul class=\"collection arqsUp\"></ul></div></div><blockquote><strong>Importante:</strong> Os afastamentos são aplicáveis <strong>apenas</strong> para efeitos de cálculo das <strong>Metas de Produtividade</strong>.<br> Dúvidas relativas aos <strong>efeitos financeiros</strong> devem ser tratadas diretamente com a <strong>COGEC</strong>.</blockquote></div></div><div class=\"modal-footer\"><a href=\"#!\" class=\"modal-close waves-effect waves-red btn-flat cancela\">Cancela</a><button class=\"btn waves-effect waves-light concorda modal-close\">Confirma <i class=\"material-icons right\">send</i></button></div></div></div></div></div></main><footer class=\"page-footer rodape\"></footer><div id=\"modal1\" class=\"modal\"><div class=\"modal-content\"><h4 class=\"hModal\">Modal Header</h4><p class=\"pModal\"></p></div><div class=\"modal-footer\"><a href=\"#!\" class=\"modal-close waves-effect waves-red btn-flat cancela\">Cancela</a><button class=\"btn waves-effect waves-light concorda modal-close\" type=\"submit\" name=\"action\">Confirma <i class=\"material-icons right\">send</i></button></div></div>");

  app_footer_tag({}, out, __component, "184");

  app_scripts_js_tag({}, out, __component, "185");
  ...
  await_reorderer_tag({}, out, __component, "191");
