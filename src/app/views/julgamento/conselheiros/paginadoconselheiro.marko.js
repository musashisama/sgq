...
function render(input, out, __component, component, state) {
  ...
  app_modal_tabela_legenda_tag({}, out, __component, "200");
  ...
  app_footer_tag({}, out, __component, "209");

  app_scripts_js_tag({}, out, __component, "210");
  ...
  await_reorderer_tag({}, out, __component, "216");
