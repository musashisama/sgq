...
function render(input, out, __component, component, state) {
  ...
  out.w("<div id=\"caixa\" class=\"container\"><div id=\"dataCAL\"" +
    ...
    "></div><div id=\"dataAlega\"" +
    marko_attr("data-alega", "" + data.alegacoes) +
    "></div><div id=\"dataUser\"" +
    marko_attr("data-user", "" + data.user) +
    "></div><div id=\"dataPauta\"" +
    marko_attr("data-pauta", "" + data.pauta) +
    "></div><h3 class=\"center-align titulo\">Indicação de Processos para Pauta de Julgamento</h3><h3 class=\"center-align\">Mês <span id=\"mespauta\"></span></h3><br><h6></h6><div class=\"col s12 m12\"><div class=\"card hoverable cardAzul\"><div class=\"card-content\">Falta(m) <strong><span id=\"daps\"></span></strong> dia(s) para a próxima sessão, que será realizada em <strong><span id=\"ps\"></span></strong>.</div></div></div><div class=\"row\"><div class=\"col s6 offset-s3\"><div id=\"cardSoma\" class=\"card hoverable cardLaranja\"><div class=\"card-content \"><span class=\"card-title\">Somatório de Horas da Indicação: <span id=\"somatorioHoras\">0</span></span></div></div></div></div><div class=\"row\"><div class=\"col s12\"><ul class=\"tabs\"><li id=\"processosTab\" class=\"tab col s3\"><a href=\"#processos\">Escolher Processos</a></li><li id=\"aptidaoTab\" class=\"tab col s5 disabled\"><a href=\"#aptidao\">Verificar Alegações e Questionamentos</a></li><li id=\"confirmacaoTab\" class=\"tab col s3 disabled\"><a href=\"#confirmacao\">Confirmar Indicação</a></li></ul></div><div id=\"processos\" class=\"col s12\"><br><div class=\"row\"><div class=\"col s6 offset-s6\"><a id=\"botaoIndica\" class=\"waves-effect waves-light btn-large\"><i class=\"fas fa-arrow-alt-circle-right right\"></i>Proceder para Verificação dos Questionamentos e Alegações</a></div><div class=\"col s12\"><blockquote><strong><p class=\"valign-wrapper\"><i class=\"fas fa-info-circle medium blue-text\"></i> &nbsp; Para indicar processos para pauta, clique no processo desejado. Ao terminar suas indicações, clique no botão acima.</p></strong></blockquote></div></div><div class=\"row\"><div class=\"col s12 right-align\">");
  ...
  app_footer_tag({}, out, __component, "102");

  app_scripts_js_tag({}, out, __component, "103");
