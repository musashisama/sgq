...
function render(input, out, __component, component, state) {
  ...
  app_valor_maximo_tag({}, out, __component, "54");

  out.w("<div class=\"form-group input-field  col s2\"><label><input name=\"juntadaCheck\" id=\"juntadaCheck\" type=\"checkbox\"><span>Solicitação de Juntada Pendente?</span></label></div></div><div class=\"row\"><div class=\"col s12 right-align\">");
  ...
  app_modal_tabela_legenda_tag({}, out, __component, "81");
  ...
  app_footer_tag({}, out, __component, "90");

  app_scripts_js_tag({}, out, __component, "91");
