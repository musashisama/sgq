...
function render(input, out, __component, component, state) {
  ...
  app_valor_maximo_tag({}, out, __component, "60");
  ...
  app_drop_download_tag({}, out, __component, "68");

  out.w("<a href=\"#!\" id=\"mostraColunasAtividade\" title=\"Agrupar/Desagrupar por Atividade\" class=\"waves-effect waves-green hoverable z-depth-3 btn-floating blue\"><i class=\"material-icons\">unfold_less</i></a><a href=\"#!\" id=\"agrupaData\" title=\"Agrupar/Desagrupar por Data de Distribuição\" class=\"waves-effect waves-green hoverable z-depth-3 btn-floating grey\"><i class=\"material-icons\">unfold_less</i></a><a href=\"#modal2\" id=\"mostraLegenda\" title=\"Mostrar Legenda da Tabela\" class=\"waves-effect waves-purple hoverable z-depth-3 btn-floating black\"><i class=\"material-icons\">details</i></a></div></div><div id=\"tabelaRegap\"></div><p><div class=\"col s12 m12\"><div class=\"card hoverable cardVermelho\"><div class=\"card-content\"><span class=\"card-title center\">ATENÇÃO</span><a id=\"oitomilhoes\"></a>* O campo \"Valor Originário\" é extraído diretamente do e-Processo e não leva em consideração outros fatores que possam alterar o valor a ser considerado para indicação. Dessa forma, para casos concretos, deverão ser somadas a esse valor outras informações, nos termos das <strong>orientações para indicação de pauta</strong>.</div></div></div></p></div><div id=\"stats\" class=\"col s12\"><h4>Quantidade de processos por atividade:</h4><div class=\"row\"><div class=\"s12\" style=\"width:100%;\" id=\"barrasAtividade\"></div></div></div><div id=\"apes749\" class=\"col s12\"><h4 id=\"gerApes749\" class=\"center\">Gerencial Apuração Especial 749</h4><div class=\"row\"><div class=\"row\"><div class=\"col s12 right-align\"><a href=\"#!\" id=\"mostraColunasAtividadeApes\" title=\"Agrupar/Desagrupar por Atividade\" class=\"waves-effect waves-green hoverable z-depth-3 btn-floating blue\"><i class=\"material-icons\">unfold_less</i></a><a href=\"#!\" id=\"xlsxDownApes\" title=\"Download da Tabela\" class=\"waves-effect waves-yellow hoverable z-depth-3 btn-floating red\"><i class=\"material-icons\">file_download</i></a></div></div><p><div id=\"tabelaApes\"></div></p></div></div></div></div></main><footer class=\"page-footer rodape\"></footer>");

  app_modal_tabela_legenda_tag({}, out, __component, "99");
  ...
  app_footer_tag({}, out, __component, "108");

  app_scripts_js_tag({}, out, __component, "109");
