...
function render(input, out, __component, component, state) {
  ...
  app_valor_maximo_tag({}, out, __component, "56");
  ...
  app_modal_tabela_legenda_tag({}, out, __component, "100");
  ...
  app_footer_tag({}, out, __component, "109");

  app_scripts_js_tag({}, out, __component, "110");
