...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"container\"><h3 class=\"center-align titulo\">Diagnóstico da Carga de Processos dos Conselheiros</h3><br><br><form id=\"formGerencial\" name=\"formGerencial\" action=\"/julgamento/restrito/diagnostico-carga\" method=\"post\"><div class=\"row\"><div class=\"col s12\"><ul class=\"tabs\"><li class=\"litab tab col s3\"><a href=\"#tabTabela\">Carga dos Conselheiros</a></li><li class=\"libox tab col s3\"><a href=\"#tabBoxplot\">Carga nas Seções de Julgamento</a></li><li class=\"libar tab col s3\"><a href=\"#tabBarras\">Carga por Seção/Conselheiro</a></li></ul></div><div id=\"tabTabela\" class=\"col s12\"><div class=\"row\"><div class=\"col s12 right-align\"><a href=\"#!\" id=\"mostraColunas\" title=\"Agrupar/Desagrupar por Turma\" class=\"waves-effect waves-yellow hoverable z-depth-3 btn-floating blue\"><i class=\"material-icons\">unfold_less</i></a></div><p id=\"resultado\"></p><div class=\"tabelaCarga\"><div id=\"tabelaCarga\"></div></div><div id=\"dadosCarga\" class=\"controle\">" +
  ...
  await_reorderer_tag({}, out, __component, "93");
