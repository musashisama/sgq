...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/sgq$1.0.0/src/app/views/julgamento/escolhecsv/escolhecsvanaliseestoque.marko",
...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.dados, function(dado) {
    ...
    out.w("<p><br><a class=\"btn-floating btn-insere halfway-fab waves-effect waves-light red\" title=\"Clique para acessar relatório\"" +
      marko_attr("href", "/julgamento/restrito/analise-estoque/" + dado.caminho) +
...
marko_template.meta = {
    id: "/sgq$1.0.0/src/app/views/julgamento/escolhecsv/escolhecsvanaliseestoque.marko",
    tags: [
