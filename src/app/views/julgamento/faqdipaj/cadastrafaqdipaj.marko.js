...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"container\"><h3 class=\"center-align titulo\">Cadastro de Perguntas & Respostas - DIPAJ/COJUL</h3><br><div class=\"row\"><h5 class=\"\">Pergunta</h5><br><div id=\"editorPergunta\" class=\"col s12\"><p id=\"perguntaFAQ\"></p><br></div></div><div class=\"row\"><h5 class=\"\">Resposta</h5><br><div id=\"editorResposta\" class=\"col s12\"><p id=\"respostaFAQ\"></p><br></div></div><div class=\"row\"><div class=\"input-field col s4\"><select required name=\"secaoFAQ\" id=\"secaoFAQ\"><option value=\"\" disabled selected>Escolha uma opção:</option><option value=\"prod\">Meta de Produtividade</option><option value=\"regap\">REGAP</option><option value=\"reinp\">REINP</option><option value=\"rejul\">REJUL</option><option value=\"sorteio\">Sorteio</option><option value=\"notificacao\">Notificações</option><option value=\"sessaovirtual\">Sessões Virtuais</option></select><label>Qual a seção do FAQ?</label></div></div><div id=\"rowArquivo\" class=\"row\"><h5 class=\"\">Anexos</h5><div class=\"row\"><div class=\"file-field left ctoastsucesso input-field form-group col s6\"><div class=\"btn\"><span>Arquivo</span><input type=\"file\" name=\"filetoupload\" id=\"file\" accept=\".pdf\" onchange=\"handleFile(this.files[0], 'POST')\" required></div><div class=\"file-path-wrapper\"><input class=\"file-path validate\" type=\"text\"></div><div class=\"hidden progress\"><div class=\"determinate\"></div></div></div></div><div class=\"row valign-wrapper\"><div id=\"mostraArq\" class=\"col s6\"><ul class=\"collection arqsUp\"></ul></div><div id=\"enviaArq\" class=\"col s6 valign-wrapper\"></div></div></div><div class=\"row\"><div class=\"col s1 offset-s11\"><a id=\"aModal\" class=\"btn-floating btn-insere waves-effect waves-light red\" title=\"Clique para enviar\"" +
