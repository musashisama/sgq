...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/sgq$1.0.0/src/app/views/gestao/usuarios/caduser.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<header class=\"container-header cabecalho\"></header><main class=\"conteudoPrincipal\"><div class=\"container\"><h3 class=\"center-align\">Adicionar Usuário</h3><br><br><form id=\"formuser\" name=\"formUser\" action=\"/admin/caduser\" method=\"post\">");
...
marko_template.meta = {
    id: "/sgq$1.0.0/src/app/views/gestao/usuarios/caduser.marko",
    tags: [
