...
estoqueGeral = estoqueGeral.sort((a, b) => {
  return a.HE_CARF - b.HE_CARF;
});
...
Plotly.newPlot(
  document.getElementById('boxPlotCSRF'),
  separaSJ(csrf),
  layout0,
  config,
);
...
Plotly.newPlot(
  document.getElementById('boxPlotSJ1'),
  separaSJ(sj1),
  layout1,
  config,
);
...
Plotly.newPlot(
  document.getElementById('boxPlotSJ2'),
  separaSJ(sj2),
  layout2,
  config,
);
...
Plotly.newPlot(
  document.getElementById('boxPlotSJ3'),
  separaSJ(sj3),
  layout3,
  config,
);
...
Plotly.newPlot(
  document.getElementById('barrasCSRF'),
  [separaSJCons(csrf, corCSRF)],
  layoutCSRF,
  config,
);
Plotly.newPlot(
  document.getElementById('barrasSJ1'),
  [separaSJCons(sj1, corsj1)],
  layoutSJ1,
  config,
);
Plotly.newPlot(
  document.getElementById('barrasSJ2'),
  [separaSJCons(sj2, corsj2)],
  layoutSJ2,
  config,
);
Plotly.newPlot(
  document.getElementById('barrasSJ3'),
  [separaSJCons(sj3, corsj3)],
  layoutSJ3,
  config,
);
