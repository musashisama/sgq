...
function dataTable(msg) {
    ...
    table = new Tabulator("#tabelaRegap", {
        ...
        columns: [
            ...
            { title: "Processo", field: "Processo", sorter: "number", hozAlign: "center", headerFilter: "input", editor: false, responsive: 0,download:true, },
            ...
            { title: "Horas CARF", field: "HE_CARF", sorter: "number", hozAlign: "center", headerFilter: "input", editor: false, responsive: 0,download:true, },
            { title: "Dias na Atividade", field: "Dias_na_Atividade", sorter: "number", hozAlign: "center", editor: false, formatter: coloreDias, responsive: 0 ,download:true},
