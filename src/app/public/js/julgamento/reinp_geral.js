...
function dataTable(msg) {
    ...
    table = new Tabulator("#tabelaReinp", {
        ...
        columns: [
            ...
            { title: "CPF", field: "cpf", sorter: "string", hozAlign: "left", headerFilter: "input", editor: false, responsive: 1, formatter: formatNome, download: true, },
            { title: "Responsável", field: "nome", sorter: "string", hozAlign: "left", headerFilter: "input", editor: false, formatter: formatNome, responsive: 0, download: true, },
            { title: "Equipe", field: "Equipe", sorter: "string", hozAlign: "center", headerFilter: "input", editor: false, responsive: 0, download: true, },
            { title: "1º Trimestre", field: "t1", sorter: "number", hozAlign: "center", editor: false, formatter: formatTrimestre, topCalc: somaCalc, responsive: 0, download: true, },
            { title: "2º Trimestre", field: "t2", sorter: "number", hozAlign: "center", editor: false, formatter: formatTrimestre, topCalc: somaCalc, responsive: 0, download: true, },
            { title: "3º Trimestre", field: "t3", sorter: "number", hozAlign: "center", editor: false, formatter: formatTrimestre, topCalc: somaCalc, responsive: 0, download: true, },
            { title: "4º Trimestre", field: "t4", sorter: "number", hozAlign: "center", editor: false, formatter: formatTrimestre, topCalc: somaCalc, responsive: 0, download: true, },
            { formatter: "responsiveCollapse", width: 50, minWidth: 30, hozAlign: "left", resizable: false, headerSort: false, responsive: 0, download: true, },
            { title: "Janeiro", field: "jan", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Fevereiro", field: "fev", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Março", field: "mar", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Abril", field: "abr", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Maio", field: "mai", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Junho", field: "jun", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Julho", field: "jul", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Agosto", field: "ago", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Setembro", field: "set", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Outubro", field: "out", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Novembro", field: "nov", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
            { title: "Dezembro", field: "dez", width: largColuna, sorter: "number", hozAlign: "center", editor: false, formatter: formatMes, responsive: 2, download: true, },
...
var trace1 = {
    ...
    text: Object.values(graf).map(d => {return +d.toFixed(2)}),
    textposition: 'auto',
    hoverinfo: 'none',
}
var trace2 = {
